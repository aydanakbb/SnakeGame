...
var _game = require("./moduller/Game");
var _gameDefault = parcelHelpers.interopDefault(_game);
const game = new (0, _gameDefault.default)();

},{"./moduller/Game":"hEGBy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hEGBy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Game {
    constructor(){
        this.gamePlayer = new (0, _snakeDefault.default)();
        this.gameItem = new (0, _itemDefault.default)("item");
        this.gameStatus = new (0, _statusDefault.default)();
        this.direction = "";
    ...
    oyun() {
        try {
            ...
            console.log(this.gamePlayer.X, this.gamePlayer.Y, this.gameItem.X, this.gameItem.Y);
        } catch (error) {
    ...
    ustUsteGeldimi(oyuncuPozisyonuX, oyuncuPozisyonuY) {
        if (this.gameItem.X === oyuncuPozisyonuX && this.gameItem.Y === oyuncuPozisyonuY) {
            console.log("\xdcst \xfcste geldiler.");
...
},{"./Item":"dv1oH","./Snake":"lH4Y6","./Status":"2eCVv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dv1oH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Item {
...
},{}],"lH4Y6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Snake {
    ...
    set X(value) {
        if (value < this._minX || value > this._maxX) throw new Error("Sınır dışına \xe7ıkıldı.");
        this.hareketEt(); //eksik yazılmış, burayı ekledim. Yapılan işlemde hareket ettirilmesi sağlanıyor.
        this.bas.style.left = value + "px";
    }
    set Y(value) {
        if (value < this._minY || value > this._maxY) throw new Error("Sınır dışına \xe7ıkıldı.");
        this.hareketEt(); //eksik yazılmış, burayı ekledim. Yapılan işlemde hareket ettirilmesi sağlanıyor.
    ...
    hareketEt() {
        ...
        for(let i = this.govde.length - 1; i > 0; i--){
            let tempPositionX = this.govde[i - 1].offsetLeft;
            let tempPositionY = this.govde[i - 1].offsetTop;
            this.govde[i].style.left = tempPositionX + "px";
            this.govde[i].style.top = tempPositionY + "px";
        }
    }
}
exports.default = Snake;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2eCVv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Status {
    _scoreValue = 0;
    ...
    skoruArtir() {
        ...
        this._scoreElement.innerHTML = this._scoreValue.toString();
        if (this._scoreValue % this._scoreDivider == 0) this.artirSeviyeyi();
    }
    artirSeviyeyi() {
        this._levelValue++;
        this._levelElement.innerHTML = this._levelValue.toString();
...
exports.default = Status; /*const status1 = new Status(); İlgili blok bizim score ve level değişkenlerini kontrol etmemizi sağlamak amaçlı kurulmuştu.
  
  for (let i = 1; i < 11; i++) {
    status1.skoruArtir();
  }*/ 

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lSgxL","kuM8f"], "kuM8f", "parcelRequired689")
